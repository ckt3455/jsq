...
<div class="row">
    ...
    <?= $form->field($model, 'type',['options'=>['tag'=>false]])->dropDownList([1=>'银行卡',2=>'支付宝'],['prompt'=>'']) ?>


    <?php echo  $form->field($model, 'status',['options'=>['tag'=>false]])->dropDownList(\backend\models\UserApply::$status_message,['prompt'=>'']) ?>
